...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.code == 200) {
      ...
      setStatus({ succes: false, message: 'Ocurrió un error. Por favor, inténtenlo en otro momento.'});
    }
  };
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="6" value={formDetails.message} placeholder="Mensaje/comentario" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
